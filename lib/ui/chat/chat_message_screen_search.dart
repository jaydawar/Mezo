...
class ChatMessageScreenSearch extends StatefulWidget {
  String otherUserId;
  String myUserId;
  ...
  State<StatefulWidget> createState() {
    return _ChatMessageScreenSearch();
  }
}

class _ChatMessageScreenSearch extends State<ChatMessageScreenSearch> {
  int _limit = 20;
        ...
        children: [
          Column(
            ...
            children: <Widget>[
              ...
              Visibility(
                visible: isSearchInitialted ? false : false,
                child: Row(
              ...
              Visibility(visible: true, child: _searchBar()),
              userName(),
              Expanded(
